<?php
    ...
    define("APP_LOGO",$settings_details['app_logo']);
     ...
     define("HOME_LATEST_LIMIT",$settings_details['home_latest_limit']);
    define("HOME_MOST_VIEWED_LIMIT",$settings_details['home_most_viewed_limit']);
    define("HOME_MOST_RATED_LIMIT",$settings_details['home_most_rated_limit']);
